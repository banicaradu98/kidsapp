...
export const metadata = {
  ...
  openGraph: { title: "Spectacole pentru Copii în Sibiu — KidsApp", description: "Teatru, circ și spectacole pentru copii la Teatrul Gong și alte locuri din Sibiu.", url: "/spectacole" },
};
