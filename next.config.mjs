...
const securityHeaders = [
  ...
  // Tighten with nonces in future if needed.
  {
    ...
    value: [
      "default-src 'self'",
      "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://accounts.google.com https://www.googletagmanager.com https://www.google-analytics.com https://ssl.google-analytics.com",
      "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com",
      "font-src 'self' https://fonts.gstatic.com",
      `img-src 'self' data: blob: https: http:`,
      "frame-src https://maps.google.com https://www.google.com https://accounts.google.com",
      `connect-src 'self' https://${supabaseHost} https://*.supabase.co https://*.supabase.io wss://${supabaseHost} https://www.google-analytics.com https://analytics.google.com https://stats.g.doubleclick.net https://region1.google-analytics.com`,
