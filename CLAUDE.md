...
- **`SectionedEvenimente`** — împarte evenimentele în 3 secțiuni vizuale pe baza poziției în listă (nu există coloană `event_date` momentan)
- **Imagini** — nu există upload de imagini; fiecare listing afișează un gradient + emoji din CATEGORY_META
